---- MODULE CascadeCore_TTrace_1784577151 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CascadeCore_TTrace_1784577151.json", _TETrace)
...
\*
\*trace == IODeserialize("CascadeCore_TTrace_1784577151.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG CascadeCore_TTrace_1784577151 ----
CONSTANTS
    MaxRev = 5
    ValueSet = { 0 , 1 , 2 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon Jul 20 14:52:31 CDT 2026