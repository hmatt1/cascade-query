...
if __name__ == "__main__":
    ...
    print("Notice how query_a and query_b both appear to depend on the same grouped process_item block.")
    print("A visual inspection might lead someone to falsely believe they share a dependency,")
