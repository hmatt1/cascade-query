    ...
    for i, line in enumerate(lines):
        ...
        if in_async:
            if (
                ...
                or 'self._store.trace_event("disk_red"' in line
                or "if not isinstance(" in line
                or 'self._store.trace_event("disk_unkeyed"' in line
                or 'self._store.trace_event("disk_miss"' in line
            ):
