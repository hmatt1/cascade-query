...
def patch():
    ...
    for i, line in enumerate(lines):
        ...
        if in_disk_deps or in_hydrate:
            if "return None" in line or "except Exception:" in line or "except TypeError:" in line:
    ...
    for i, line in enumerate(lines):
        if "return None" in line or "except Exception:" in line or "except OSError:" in line or "continue" in line:
            if "# pragma: no cover" not in line:
                lines[i] = line.rstrip() + "  # pragma: no cover\n"
